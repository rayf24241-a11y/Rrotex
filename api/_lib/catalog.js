...
const MODELS = {
  fast: {
    ...
    orModel: process.env.OPENROUTER_FAST_MODEL || 'meta-llama/llama-3.1-8b-instruct',
  ...
  balanced: {
    ...
    orModel: process.env.OPENROUTER_BALANCED_MODEL || 'qwen/qwen3-32b',
  ...
  smart: {
    ...
    orModel: process.env.OPENROUTER_SMART_MODEL || 'meta-llama/llama-3.3-70b-instruct',
