...
## Video Hook
I made an AI website that can chat, code, read files and images, create downloads, and connect my phone to my PC so I can control computer tasks from anywhere on WiFi.

## Places To Share Legit
- GitHub repo README and profile
- Product Hunt upcoming page
- Indie Hackers launch post
- Dev.to build log
- YouTube Shorts/TikTok demos
- Reddit communities only where self-promo is allowed
- Discord servers only in showcase channels
